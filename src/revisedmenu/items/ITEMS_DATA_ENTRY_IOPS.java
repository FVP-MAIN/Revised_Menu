...
public class ITEMS_DATA_ENTRY_IOPS extends javax.swing.JInternalFrame {
 ...
 Date Date_Input;
     ...
     public void updateVTypeList() {     
       Connection conn_obj = OracleSqlConnect.ConnectDB();
        try {       
            ...
            String sql_list1 = "SELECT DISTINCT VTYPE FROM ITEMS_IOPS";
            ...
            Logger.getLogger(ITEMS_DATA_ENTRY_IOPS.class.getName()).log(Level.SEVERE, null, ex);
        }
      ...
      public void updateITEM_CATypeList() {
        ...
        try {
                    ...
                    String sql_list2 = "SELECT DISTINCT ITMCATEGORY FROM ITEMS_IOPS";
       ...
       public void updatePRODTypeList() {
        ...
        try {
                    ...
                    String sql_list3 = "SELECT DISTINCT PRDUCTS FROM ITEMS_IOPS WHERE FORSALE = 'T'";
    ...
    public void updateCOLORTypeList() {
        ...
        try {
                    ...
                    String sql_list4 = "SELECT DISTINCT CLORS FROM ITEMS_IOPS";
    ...
    public void updateSIZETypeList() {
        ...
        try {
                    ...
                    String sql_list5 = "SELECT DISTINCT SZES FROM ITEMS_IOPS";
    ...
    private void jitem_codeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jitem_codeActionPerformed
        ...
        try{
            ...
            /* Selected Table*/
            String search_sql = "SELECT * FROM ITEMS_IOPS WHERE ITMCOD = '"+itm_code+"'";
    ...
    private void SAVEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SAVEActionPerformed
        ...
        qon=jqon.getText().trim();
            ...
            if(!jitem_code.getText().isEmpty()){         
           String checkExistenceSql = "SELECT COUNT(*) FROM ITEMS_IOPS WHERE ITMCOD = ?";
                try (PreparedStatement stmt_checkExistence = conn_obj.prepareStatement(checkExistenceSql)) {
                    ...
                    try (ResultSet rs_checkExistence = stmt_checkExistence.executeQuery()) {
                        ...
                        if (rowCount == 0) {
                           String insert_sql = "INSERT INTO ITEMS_IOPS (ITMCOD, DTE_ENCODED, GTIN, VTYPE, ITMCATEGORY, FORSALE, DES, SUPNME, PRDUCTS, CATEG, "
                            ...
                            try (PreparedStatement stmt_insert = conn_obj.prepareStatement(insert_sql)) {
                                ...
                                stmt_insert.executeUpdate();                             
                                 ...
                                 String update_sql = "UPDATE ITEMS_IOPS SET ITMCOD = ?, DTE_ENCODED = ?, GTIN = ?, VTYPE = ?, ITMCATEGORY = ?, FORSALE = ?, "
                                    + "DES = ?, SUPNME = ?, PRDUCTS = ?, CATEG = ?, UNT = ?, CLORS = ?, SZES = ?, WEIGHT = ?, "
                            ...
                            try (PreparedStatement stmt_save = conn_obj.prepareStatement(update_sql)) {
                                ...
                                stmt_save.setString(2, date_enc);
                                stmt_save.setString(3, gtin);
                                stmt_save.setString(4, vtype);
                                stmt_save.setString(5, itm_cat);
                                stmt_save.setString(6, msvita);
                                stmt_save.setString(7, des);
                                stmt_save.setString(8, supp);
                                stmt_save.setString(9, prods);
                                stmt_save.setString(10, cat);
                                stmt_save.setString(11, unit1);
                                stmt_save.setString(12, colors);
                                stmt_save.setString(13, size);
                                stmt_save.setObject(14, wght);
                                stmt_save.setObject(15, discount);
                                stmt_save.setObject(16, sp);
                                stmt_save.setObject(17, qty);
                                stmt_save.setString(18, phase);
                                stmt_save.setString(19, itm_code);
   ...
   var_type.dispose();
    ...
    private void VarSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_VarSearchActionPerformed
        ...
        try {       
            DefaultListModel vt_model = new DefaultListModel();      
            String sql_list1 = "SELECT DISTINCT VTYPE FROM ITEMS_IOPS WHERE VTYPE LIKE ?";
            PreparedStatement stmt_list1 = conn_obj.prepareStatement(sql_list1);
    ...
    private void ItemSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ItemSearchActionPerformed
        ...
        try {       
            DefaultListModel item_cat_model = new DefaultListModel();
            String sql_list2 = "SELECT DISTINCT ITMCATEGORY FROM ITEMS_IOPS WHERE ITMCATEGORY LIKE ? ";
            PreparedStatement stmt_list2 = conn_obj.prepareStatement(sql_list2);
    ...
    private void ProdSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ProdSearchActionPerformed
       ...
       String searchText = ProdSearch.getText().trim();
        try {
                    DefaultListModel prod_model = new DefaultListModel();
                    String sql_list3 = "SELECT DISTINCT PRDUCTS FROM ITEMS_IOPS WHERE FORSALE = 'T' AND PRDUCTS LIKE ? ";
                    PreparedStatement stmt_list3 = conn_obj.prepareStatement(sql_list3);
    ...
    private void ColorSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ColorSearchActionPerformed
         ...
         try {
                    DefaultListModel color_model = new DefaultListModel();
                    String sql_list4 = "SELECT DISTINCT CLORS FROM ITEMS_IOPS WHERE CLORS LIKE ? ";
                    PreparedStatement stmt_list4 = conn_obj.prepareStatement(sql_list4);
    ...
    private void SizeSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SizeSearchActionPerformed
        ...
        try {
                    DefaultListModel size_model = new DefaultListModel();
                    String sql_list5 = "SELECT DISTINCT SZES FROM ITEMS_IOPS WHERE SZES LIKE ? ";
                    PreparedStatement stmt_list5 = conn_obj.prepareStatement(sql_list5);
   ...
   if(evt.getClickCount()==3){  
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ITEMS_DATA_ENTRY_IOPS().setVisible(true);
            }
        });
    }
